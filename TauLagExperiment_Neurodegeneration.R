...
p1_all<-gplot2(df[df$TimeCut == "(-2,0]",], "E_tau", "ADsig", "Log Transformed tTau",
          "Normalized AD Signature Cortical Thickness", c(-2, 2),c(4, 7), 1.4, 6.5, 5.9)

p1_pos<-gplot2(df[df$TimeCut == "(0,2]"& df$PIBpos == 1,], "E_tau", "ADsig", "Log Transformed tTau",
              "Normalized AD Signature Cortical Thickness",c(-2, 2),c(4, 7), 1.4, 6.5, 5.9)

p1_neg<-gplot2(df[df$TimeCut == "(0,2]"& df$PIBpos == 0,], "E_tau", "ADsig", "Log Transformed tTau",
               "Normalized AD Signature Cortical Thickness",c(-2, 2),c(4, 7), 1.4, 6.5, 5.9)
...
p_overall<-ggplot(ForPlot, aes(x = TimeCut, y = Estimate)) + geom_point(size = 3) + 
  ...
  xlab("Time Window") + ylab("AD Cortical Thickness - CSF tTau Correlation")+ ggtitle("All Participants")+ ylim(c(-0.65, 0.65))+ theme_classic()
...
p_pos<-ggplot(ForPlot, aes(x = TimeCut, y = Estimate)) + geom_point(size = 3) + 
  geom_errorbar(aes(ymin=(CI_lower + Estimate)/1.96, ymax=(CI_upper+Estimate)/1.96), width=.1)+
  xlab("Time Window") + ylab("AD Cortical Thickness - CSF tTau Correlation")+ ggtitle("Amyloid Positive Individuals")+ ylim(c(-0.65, 0.65))+ theme_classic()
...
p_neg<-ggplot(ForPlot, aes(x = TimeCut, y = Estimate)) + geom_point(size = 3) + 
  geom_errorbar(aes(ymin=(CI_lower + Estimate)/1.96, ymax=(CI_upper+Estimate)/1.96), width=.1)+
  xlab("Time Window") + ylab("AD Cortical Thickness - CSF tTau Correlation")+ ggtitle("Amyloid Negative Individuals")+ ylim(c(-0.65, 0.65))+ theme_classic()
...
b <- c(-0.6, 0, 0.6)
MakeBrainPlot("(-13,-10]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(-10,-8]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(-8,-6]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(-6,-4]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(-4,-2]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(-2,0]", b, -0.6, 0.6, RegionalResult_plot)
MakeBrainPlot("(0,2]", b, -0.6, 0.6, RegionalResult_plot)
...
MakeBrainPlot("(-8,-6]", b, -0.6, 0.6, RegionalResult_plot_PIBpos)
MakeBrainPlot("(-6,-4]", b, -0.6, 0.6, RegionalResult_plot_PIBpos)
MakeBrainPlot("(-4,-2]", b, -0.6, 0.6, RegionalResult_plot_PIBpos)
MakeBrainPlot("(-2,0]", b, -0.6, 0.6, RegionalResult_plot_PIBpos)
MakeBrainPlot("(0,2]", b, -0.6, 0.6, RegionalResult_plot_PIBpos)
